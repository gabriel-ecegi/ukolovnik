...
const StyledWrapper = styled.div<{
  ...
  input {
    padding: ${(props) => props.theme.spacing(0.9, 1.4)};
    font: inherit;
    font-size: 16px;
    font-weight: 600;
    line-height: 1.4;
    ...
    &:focus + .bl-date-range-picker__fieldset {
      border-width: 2px;
    }
  ...
  .bl-date-range-picker__fieldset {
    position: absolute;
    left: 0;
    right: 0;
    bottom: 0;
    ...
    border-radius: 8px;
    ${(props) => props.$isOpen && "border-width: 2px;"}
...
const getPopupCss = (theme: Theme) => `  
  .container {
    --color-fg-primary: ${theme.palette.primary.main};
    --color-fg-accent: ${theme.palette.primary.main};
    --border-radius: 4px;
    --color-bg-inrange: ${theme.colors.primaryMainTransparent};
    --color-bg-secondary: ${theme.palette.common.white};
  ...
  .preset-plugin-container .preset-button {
    font: inherit;
    font-size: 12px;
    font-weight: 600;
    border-radius: 28px;
  ...
  .preset-plugin-container .preset-button:last-child {
    margin-bottom: 0;
  }

  .preset-plugin-container .preset-button:hover {
    box-shadow: ${theme.shadow.primaryHover};
  }

  .container.preset-plugin .preset-plugin-container {
    width: 170px !important;
  }

  .container.amp-plugin .calendars .calendar > .header .reset-button svg {
    width: 16px;
    height: auto;
  }
...
/* copy of https://cdn.jsdelivr.net/npm/@easepick/bundle@1.2.0/dist/index.css */
const copyOfLibraryStyles = `:host {
...
export const BlDateRangePickerStyles = {
  StyledWrapper,
  StyledCrossIcon,
  getPopupCss,
  copyOfLibraryStyles,
